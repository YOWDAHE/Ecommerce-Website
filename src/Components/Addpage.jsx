        ...
        <div className=' w-full lg:w-4/12 md:w-7/12 text-black flex flex-col items-center p-5'>
          <form className="flex flex-col justify-center w-full" onSubmit={handleUpload}>
            <div>
              ...
              <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none disabled:bg-red-500  disabled:hover:opacity-10 disabled:cursor-not-allowed dark:focus:ring-blue-800 m-4" disabled={percentage == null || (percentage != null && percentage < 100)} >{subited ? 'Submited' : 'Submit'}</button>
            </div>
          </form>
